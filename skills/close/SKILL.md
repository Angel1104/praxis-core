...
3. Run the full test suite for this CR:
   ```bash
   [run the project's test suite for this CR]
   ```
...
## Phase 2: Lessons Learned (visible)
...
**Always report what was considered and what was kept or discarded**, so the human can see this phase working:

> **Lessons learned assessment:**
> - Considered: [candidate lesson] → **Kept** / **Discarded** ([reason])
> - [repeat for each candidate]
> - Result: [N lessons written to `specs/lessons-learned.md`] / [No genuine lessons from this CR]
...
| `references/lessons-learned-rules.md` | When to capture, quality gate, entry format |
